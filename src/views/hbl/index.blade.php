...
<link href="{{ asset('assets/bickyraj/css/hbl.css') }}" rel="stylesheet" type="text/css">
<link type="text/css" rel="stylesheet" href="{{ asset('assets/bickyraj/css/hbl_nova.css') }}">
<link type="text/css" rel="stylesheet" href="{{ asset('assets/bickyraj/css/theme.css') }}">
...
<link type="text/css" rel="stylesheet" href="{{ asset('assets/bickyraj/css/hbl(1).css') }}">
</head>
<body>
<form class="jotform-form" action="{{ route('bickyraj.hbl.paymentrequest') }}" method="post" enctype="multipart/form-data" name="form_payment" id="" accept-charset="utf-8">
           ...
           <div class="vacancy_content">
              ...
              <div id="vacancy_body">
				...
				<div class="vacancy_desc">
                  ...
                  <div class="vacancy_desc">
						<span>
						 <input type="tel" id="success_url" name="success_url" class="form-textbox" size="50" value="{{ route('bickyraj.hbl.payment.success') }}">
						 <label class="form-sub-label" for="success_url" id="sublebel_success_url" style="min-height:13px"> Success URL </label>
					 </span>
                  </div>
                  <div class="vacancy_desc">
						<span>
						 <input type="tel" id="fail_url" name="fail_url" class="form-textbox" size="50" value="{{ route('bickyraj.hbl.payment.failed') }}">
						 <label class="form-sub-label" for="fail_url" id="sublebel_fail_url" style="min-height:13px"> Failed URL </label>
					    </span>
                  </div>
                  <div class="vacancy_desc">
						<span>
						 <input type="tel" id="cancel_url" name="cancel_url" class="form-textbox" size="50" value="{{ route('bickyraj.hbl.payment.canceled') }}">
